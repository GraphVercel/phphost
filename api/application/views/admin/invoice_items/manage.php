...
<?php
    ...
    render_datatable($table_data, 'invoice-items'); ?>
                ...
                <div id="imageModal" class="modal">
                  <span class="close_item">&times;</span>
...
function items_bulk_action(event) {
    ...
    function previewImage_item(image) {
    ...
    var closeButton = document.querySelector(".close_item");
    closeButton.addEventListener("click", closeModal_item);
